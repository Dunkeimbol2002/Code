...
if (isset($_POST["consultar"])) {
    ...
    if (
        ...
        && !isset($cargo) && !isset($actividad_principal) && !isset($subactividad) && !isset($desde) && !isset($hasta)
    ) {
        $sql_egresos .= " ";
    } else {
        ...
        if (!empty($desde) && !empty($hasta)) {
            $sql_egresos .= " AND dev.fyh_creacion between '" . $desde . "' and '" . $hasta . "'";
        }
    }
            ...
            <div class="row mb-2">
                <div class="col-sm-9">
                    <h1 class="m-0"><b>Consulta de Egresos</b>
                        ...
                        <a href="<?php echo $URL; ?>/app/controllers/egreso/exportar_excel.php" type="button"
                                        ...
                                        <center>
                                            <div class="btn-group">
                                                ...
                                                <a href="informe.php?id=<?php echo $id_egresos; ?>" target="_blank"
                                                    ...
                                                    id="boton_imprimir<?php echo $id_egresos; ?>"><i
