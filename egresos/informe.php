...
$pdf->SetFont('Arial', 'I', 9);  //fuente
$pdf->Cell(15); //mover a la derecha
$pdf->MultiCell(158, 5, utf8_decode('Por medio del presente se informan los egresos referentes al ' . mb_convert_case($nombre_actividad, MB_CASE_TITLE, "UTF-8") . ', en mérito a la Resolución Rectoral Nº' . $resolucion_directoral . '-' . $anio_fecha_resolucion . '-CU-UNFV del ' . $dia_resolucion . '.' . $mes_resolucion . '.' . $anio_resolucion . ' el cual es el siguiente:')); //texto
...
$pdf->Cell(15); //mover a la derecha
$pdf->Cell(40, 10, utf8_decode('Asimismo, se adjunta cuadro Excel detallado.')); //texto
