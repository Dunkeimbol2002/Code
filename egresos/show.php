...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><b>Datos del Egreso</b></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><i class="bi bi-search"></i> Informacion de Egreso</a></li>
                    </ol>
                </div>
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-md-12">
                    <div class="card card-dark">
                        <div class="card-header">
                            <h3 class="card-title">Informacion de egreso seleccionado</h3>
                            ...
                            <form action="#">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="asunto" rows="3"
                                                placeholder="Asunto" disabled><?php echo $asunto_conta; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-4" id="campo_observacion">
                                        ...
                                        <input type="text" class="form-control " name="observacion" disabled
