...
if ($contador == 1) {
    ...
    informe,fecha_informe,resolucion_directoral,fecha_resolucion,total_egresos,total_acumulado,visible,id_usuario,fyh_creacion) 
    ...
    :fecha_dependencia,:id_cargo_dependencia,:id_actividad_dependencia,:id_subactividad,:monto,:id_concepto_giro,:id_modalidad_pago,:proveedor,:ruc,
